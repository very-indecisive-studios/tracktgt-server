...
public class GetUserFollowersTest
{
    ...
    private static GetUserFollowersHandler? GetUserFollowersHandler { get; set; }
    ...
    public static async Task TestClassInit(TestContext context)
    {
        ...
        GetUserFollowersHandler = new GetUserFollowersHandler(InMemDatabase, Mapper);
    }

    [TestMethod]
    public async Task GetUserFollowers_Default()
    {
        // Setup
        var query = new GetUserFollowersQuery("User1");
        
        // Execute
        var result = await GetUserFollowersHandler!.Handle(query, CancellationToken.None);
